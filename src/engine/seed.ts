...
export function seedNests(): Nest[] {
  return [
    ...
    },
    {
      ...
      members: [
        { userId: ME, tier: 'inner' },
        { userId: 'u_mike', tier: 'inner' },
        { userId: 'u_insup', tier: 'regular' },
        { userId: 'u_dan', tier: 'regular' },
        { userId: 'u_eric', tier: 'outer' },
      ],
    },
    {
      id: 'n_foodies',
  ...
  return [
    {
      ...
      audience: { kind: 'nests', nestIds: ['n_satt'] },
    ...
    },
    {
      ...
      audience: { kind: 'nests', nestIds: ['n_fam', 'n_satt'] },
    ...
    },
    {
      ...
      audience: { kind: 'nests', nestIds: ['n_satt', 'n_foodies'] },
      createdAt: now - 2 * DAY,
