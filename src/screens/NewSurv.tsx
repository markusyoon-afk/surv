...
const styles = StyleSheet.create({
  ...
  ideasTitle: { color: colors.sage, fontFamily: 'SpaceGrotesk_500Medium', fontSize: 10.5, letterSpacing: 1.3 },
  ...
  ideaQ: { color: colors.white, fontFamily: 'SpaceGrotesk_500Medium', fontSize: 12.5, marginTop: 4, lineHeight: 17 },
  ...
  survitText: { color: colors.white, fontFamily: 'SpaceGrotesk_700Bold', fontSize: 17, letterSpacing: 1.2 },
});
